...
function util.GetPrinterInfo(printAmount, printDelay, explodeRandomize, lineBreak)
	return "Печатает: "..printAmount.." рублей, Задержка: "..math.floor(printDelay/60).."м, Шанс взрыва: "..math.floor((1/explodeRandomize) * 100).."%."
end